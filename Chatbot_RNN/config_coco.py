...
##### 데이터셋을 변경할 때의 도움말 ##################################################################
# 1. 아래의 데이터셋 경로 변경
tf.app.flags.DEFINE_string("train_dir", "./model_coco", "학습한 신경망을 저장할 폴더")
tf.app.flags.DEFINE_string("data_path", "./data/coco.txt", "대화 파일 위치")
tf.app.flags.DEFINE_string("voc_path", "./data/coco.voc", "어휘 사전 파일 위치")
######################################################################################################
# 2. 데이터셋으로부터 어휘 파일 생성
