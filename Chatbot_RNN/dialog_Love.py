...
class Dialog():
    ...
    def transform(self, input, output, input_max, output_max):
        enc_forward_input = self._pad(input, input_max)
        enc_reverse_input = self._pad_left(input, input_max)
    ...
    def build_vocab(self, data_path, vocab_path):
        with open(data_path, 'r', encoding='utf-8') as content_file:
            ...
            words=counter.most_common(10000)
            #pdb.set_trace()
